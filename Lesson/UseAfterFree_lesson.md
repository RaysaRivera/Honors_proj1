...
<form>
<input class="button" type = "button" onclick="window.location.href = 'https://raysarivera.github.io/Honors_proj1/Lesson/UseAfterFree_quiz'" value = "Test Your Knowledge Here!"> </form>
